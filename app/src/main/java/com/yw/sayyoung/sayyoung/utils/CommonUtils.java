...
public class CommonUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = SayYoungApp.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static boolean isNetworkConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) SayYoungApp.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
